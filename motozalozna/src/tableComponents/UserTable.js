...
import { Paper, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, Button, Container, TextField } from '@material-ui/core/'
...
const UserTable = (props) => {
  ...
  const columns = [
    ...
    { 
      id: 'loan_length', label: 'Dlzka pôžičky',
      format: (value) => value.toFixed(2),
    },
    { 
      id: 'loan_price', label: 'Výška pôžičky',
      format: (value) => value.toFixed(2),
    },
    {
                ...
                <Modal.Body>
                  {
                    <div className="text-center">
                      ...
                      <div>
                        <div className="categoryName">
                          <h3 style={{marginBottom: "10px"}}>Ostava Zaplatiť: {currentRow.loan_price} €</h3>
                          <h3 style={{marginBottom: "10px"}}>Z toho urok: {currentRow.interest} €</h3>
                        </div>
